...
namespace APG {
    public static class ExtensionMethods {
        ...
        public static Vector3 NormalizeVector3Int(this Vector3Int inVec, Vector3Int scaleVec) {
            float x = (float)inVec.x / (float)scaleVec.x;
            float y = (float)inVec.y / (float)scaleVec.y;
            float z = (float)inVec.z / (float)scaleVec.z;
